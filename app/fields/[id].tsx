...
interface Program {
  ...
  description: string;
  images?: string[];
  courses?: Course[] | string[]; // Make this optional
  careerPaths?: string[];
}
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View
          style={[styles.header, { backgroundColor: parseColor(field.color) }]}
        >
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <Text style={styles.emptyText}>
                No programs available for this field
              </Text>
            }
          />
        </View>
              ...
              {selectedProgram && (
                <>
                  ...
                  <View style={styles.modalProgramMeta}>
                    <Text style={styles.modalProgramDuration}>
                      {selectedProgram.duration}
                    </Text>
                    <Text style={styles.modalProgramLevel}>
                      {selectedProgram.level.join(" / ")}
                    </Text>
                  </View>

                  <Text style={styles.modalProgramDescription}>
              ...
              <View style={styles.schoolInfoContainer}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoText}>
                    {institutionInfo?.contact.phones.join(", ")}
                  </Text>
                </View>
                ...
                <View style={styles.infoRow}>
                  ...
                  />
                  <Text style={styles.infoText}>
                    {institutionInfo?.contact.address}
                  </Text>
                </View>
              </View>
            </ScrollView>
